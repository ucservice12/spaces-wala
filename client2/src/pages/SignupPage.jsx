...
const SignupPage = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-gray-50 flex items-center justify-center mt-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-md p-8">
        <div className="text-center mb-8 grid gap-2">
          ...
          <div className="text-sm">
            ...
            <Link to="/login" className="underline text-blue-700 underline-offset-4 ml-2">
              login
            </Link>
          </div>
        </div>
