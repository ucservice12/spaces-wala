...
import { TypographyH4, TypographyH3, TypographyH5, TypographyMuted, TypographyP, Small } from "@/custom/Typography";
...
export default function Property() {
  ...
  return (
    <>
      ...
      <div className="grid gap-2 sm:grid-cols-2 grid-cols-1 mt-12 bg-[#ebf4db] sm:w-6xl rounded-md mx-auto p-6 sm:px-12 relative">
        ...
        <Card className="p-6">
          <div>
            <TypographyH4 className="capitalize">Choose type of advertiser</TypographyH4>
